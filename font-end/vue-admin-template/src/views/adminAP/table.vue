  ...
  <div class="app-container">
    <el-form ref="form" :model="form" label-width="120px" size="mini">
      <el-form-item label="职位">
        <el-input v-model="form.AHRName" :readonly="true" />
      </el-form-item>
      <el-form-item label="基本工资">
        <el-input v-model="form.Base" @change="calculation" :readonly="true"/>
      </el-form-item>
      <el-form-item label="交通补贴">
        <el-input v-model="form.Transportation" @change="calculationAll" :readonly="true"/>
      </el-form-item>
      <el-form-item label="午餐补贴">
        <el-input v-model="form.Lunch" @change="calculationAll" :readonly="true"/>
      </el-form-item>
      <el-form-item label="通信补贴">
        <el-input v-model="form.Communication" @change="calculationAll" :readonly="true"/>
      </el-form-item>
      ...
      <el-form-item label="总金额">
        <el-input v-model="form.Tatol" :readonly="true" />
      </el-form-item>
      <el-form-item label="审核状态">
        <el-input v-model="form.State" :readonly="true" />
      </el-form-item>
      <el-form-item label="登记人(自动)">
        <el-input v-model="form.Designee" :readonly="true" />
      </el-form-item>
      ...
      <el-form-item>
        <el-button type="primary" @click="onSubmit">复核通过</el-button>
    ...
    onSubmit() {
      ...
      // this.$message('submit!')
        ...
        updateAP(this.form).then(response => {
          this.$parent.$parent.showTable = false
